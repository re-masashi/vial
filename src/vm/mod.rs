...
pub enum Operands {
    ...
    RRR { dst: Reg, src1: Reg, src2: Reg },
    
    // 2-register operations (IntNeg, Move, etc.)
    RR { dst: Reg, src: Reg },
    
    // Register + immediate
    RI8 { dst: Reg, src: Reg, imm: i8 },
    RI16 { dst: Reg, src: Reg, imm: i16 },
    RI64 { dst: Reg, imm: i64 },
    
    // Memory operations
    LoadLocal { dst: Reg, offset: u16 },
    StoreLocal { src: Reg, offset: u16 },
    LoadField { dst: Reg, ptr: Reg, offset: u16 },
    
    // Control flow
    Jump { offset: i16 },
    Branch { cond: Reg, offset: i16 },
    
    // Calls
    Call { func_id: u16, argc: u8, args: Vec<Reg> },
